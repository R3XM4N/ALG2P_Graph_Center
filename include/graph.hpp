...
private:
    ...
    unordered_map<uint64, uint32> node_to_index;
    ...
    vector<shared_ptr<Node>> node_ptr_mapping;
...
public:
    ...
    uint64 GetMinDistance(shared_ptr<Node> source_node, shared_ptr<Node> destination_node);
